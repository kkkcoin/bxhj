...
static const int64 MAX_MONEY = 1500000000 * COIN; //total of 50 million coins (incl. PoS)	
...
static const uint256 hashGenesisBlockOfficial("0x0000086636e158205b6a9315dc960be5ca5166a1b384bee0f26ed64c4045a5c6");
static const uint256 hashGenesisBlockTestNet("0x0000086636e158205b6a9315dc960be5ca5166a1b384bee0f26ed64c4045a5c6");
...
public:
    ...
    */
    ...
    /** Amount of Kraken spent by this transaction.
    ...
    /** Amount of Kraken coming in to this transaction
...
public:
    ...
    {
        // Protocol switch to support p2pool at Kraken block #9689
        ...
        // Before Kraken block #9689 - old protocol
...
uint256 nPoWBase1 = uint256("0x00000000ffff0000000000000000000000000000000000000000000000000000"); // difficulty-1 target
 
    /* New protocol */
 
    // Calculate work amount for block
    CBigNum nPoWTrust = (CBigNum(nPoWBase1) / (bnTarget+1));
    ...
    const CBlockIndex* currentIndex = pprev;
	    ...
	    // Return nPoWTrust for the first 120 blocks
    if (pprev == NULL || pprev->nHeight < 120)
        return nPoWTrust;
