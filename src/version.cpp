// Copyright (c) 2014 The Kraken developers
...
// for both Krakend and Kraken-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("Kraken");

// Client version number
#define CLIENT_VERSION_SUFFIX   "-xtra"
