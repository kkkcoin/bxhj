...
QString coinunits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("KRAK");
    case mBTC: return QString("mKRAK");
    case uBTC: return QString::fromUtf8("μKRAK");
...
QString coinunits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Kraken");
    case mBTC: return QString("Milli-Kraken (1 / 1,000)");
    case uBTC: return QString("Micro-Kraken (1 / 1,000,000)");
    default: return QString("???");
    }
}
